...
# print(f"Binary Search for Target:{key}found at {index_found}!= -1 else "Target Not Found")
...
def recurcive_binary_search(arr,target,start_index,end_index):
    ...
    if mid_val == target:
        ...
        return recurcive_binary_search(arr,target,mid + 1,end_index)
    else:
        return recurcive_binary_search(arr,target,start_index,mid - 1)